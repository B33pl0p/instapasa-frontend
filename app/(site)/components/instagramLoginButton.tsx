...
const InstagramLoginButton: React.FC = () => {
  ...
  return <button onClick={handleClick}
        className="flex items-center bg-[linear-gradient(86deg,_rgba(249,206,52,0.75)_-7.01%,_rgba(238,42,123,0.75)_52.81%,_rgba(98,40,215,0.75)_110.91%)] text-white px-2 py-2 rounded-md text-sm
