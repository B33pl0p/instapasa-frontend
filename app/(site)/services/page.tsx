...
export default function ServicesPage() {
  return (
    <main className="bg-[#161616] text-[#E8E8E8]">
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-black/70 via-blue-950/20 to-black/70">
        <div className="absolute inset-0 bg-[url('/lakhey.png')] bg-cover bg-center opacity-10"></div>
        <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 py-20 text-center max-w-[1600px] mx-auto">
          <div className="inline-block px-4 py-2 bg-blue-500/20 border border-blue-400/30 rounded-full mb-6">
            <span className="text-blue-300 text-sm font-semibold">How It Works</span>
          </div>
      ...
      {/* Steps Section */}
      <section className="py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
        <div className="max-w-[1400px] mx-auto">
          {/* Step 1 */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-16 items-center mb-24">
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-gradient-to-br from-blue-950/20 to-blue-900/10 border border-blue-500/30 rounded-2xl p-8 h-80 flex items-center justify-center">
                <svg className="w-40 h-40 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Features Overview */}
      <section className="py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 bg-gradient-to-b from-[#161616] to-[#1a1a1a]">
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
            {[
              ...
              <div key={index} className="group bg-gradient-to-br from-[#1a1a1a] to-[#161616] border border-gray-800 hover:border-blue-500/50 rounded-2xl p-8 transition-all duration-300 hover:transform hover:scale-105">
      ...
      <section className="py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-blue-900/30 to-blue-950/30 border border-blue-500/30 rounded-3xl p-8 sm:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/signup"
                className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50"
              >
                ...
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-400 to-blue-500 blur opacity-20 group-hover:opacity-40 transition-opacity"></div>
              </Link>
              <Link
                href="/#contact"
