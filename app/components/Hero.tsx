export default function Hero() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-center gap-6">
        <div className="bg-[rgba(255,255,255,0.13)]  rounded-2xl px-6 py-8 w-3/4 mx-auto  ">
